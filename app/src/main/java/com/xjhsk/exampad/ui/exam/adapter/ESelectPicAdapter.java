...
public class ESelectPicAdapter extends RecyclerView.Adapter<ESelectPicAdapter.MyViewHolder> {
    ...
    public ESelectPicAdapter(Context context,ArrayList<PaperActionOption> paperActionOptions,String zipfilename){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.e_select_pic_item, null);

        return new ESelectPicAdapter.MyViewHolder(view);
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.option_tv.setText(bean.getKey());

        Glide.with(context)
                .load(zipfilename+bean.getContent())
                .placeholder(R.drawable.e_default_img)
                .into(holder.option_img);

        if(bean.isSelect()){
            holder.option_img_select.setVisibility(View.VISIBLE);
            holder.option_img_select.setAlpha(0.8f);
        }
        else {
            holder.option_img_select.setVisibility(View.GONE);
        }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView option_img_select;
        ...
        public MyViewHolder(View itemView) {
            ...
            option_img_select = (ImageView) itemView.findViewById(R.id.option_img_select);
