...
public class ESelectSortAdapter extends RecyclerView.Adapter<ESelectSortAdapter.MyViewHolder> {
    ...
    public ESelectSortAdapter(Context context, ArrayList<PaperActionOption> paperActionOptions){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.e_select_sort_item, null);

        return new ESelectSortAdapter.MyViewHolder(view);
    }
