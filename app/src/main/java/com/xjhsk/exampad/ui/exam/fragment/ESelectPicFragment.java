...
public class ESelectPicFragment extends RootFragment<ESelectPicPresenter> implements ESelectPicContract.View  {

    private static final String TAG = ESelectPicFragment.class.getSimpleName();
    ...
    private ESelectPicAdapter eSelectPicAdapter;
        ...
        for (int i=0;i<allActionVOs.size();i++){
            ...
            switch (paperAction.getActionType()){
                ...
                case PaperAction.QUESTION_OPTION:
                    ...
                    eSelectPicAdapter = new ESelectPicAdapter(getContext(),paperAction.getPaperActionOptions(),zipfilename);
                    recyclerView.setAdapter(eSelectPicAdapter);
    ...
    public void selectItem(int postion) {
        ...
        for (int i=0;i<eSelectPicAdapter.getPaperActionOptions().size();i++){
            PaperActionOption paperActionOption = eSelectPicAdapter.getPaperActionOptions().get(i);
            if(postion == i){
        ...
        eSelectPicAdapter.notifyDataSetChanged();
    ...
    protected int getLayoutId() {
        return R.layout.fragment_e_select_pic;
    }
    ...
    public static ESelectPicFragment newInstance(String zipfilename ,PaperSection paperSection) {
        Bundle args = new Bundle();

        ESelectPicFragment fragment = new ESelectPicFragment();
