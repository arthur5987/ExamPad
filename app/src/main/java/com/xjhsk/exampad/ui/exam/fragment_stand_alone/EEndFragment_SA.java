package com.xjhsk.exampad.ui.exam.fragment_stand_alone;
...
public class EEndFragment_SA extends RootFragment<EEndPresenter> implements EEndContract.View  {

    private static final String TAG = EEndFragment_SA.class.getSimpleName();
...
//        });
    ...
    public static EEndFragment_SA newInstance(String userDir, PagerInfo pagerInfo) {
        Bundle args = new Bundle();
        EEndFragment_SA fragment = new EEndFragment_SA();
...
//        RxTimerUtil.timer(1000 * 2, new RxTimerUtil.IRxNext() {
//            @Override
//            public void doNext(long number) {
//                mPresenter.createJsonFileAndZip(userDir,pagerInfo);
