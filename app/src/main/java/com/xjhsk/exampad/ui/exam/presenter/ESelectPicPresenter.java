...
public class ESelectPicPresenter extends RxPresenter<ESelectPicContract.View> implements ESelectPicContract.Presenter {

    protected static final String TAG = ESelectPicPresenter.class.getSimpleName();

    private DataManager mDataManager;

    @Inject
    public ESelectPicPresenter(DataManager mDataManager) {
        this.mDataManager = mDataManager;
    }

    @Override
    public void attachView(ESelectPicContract.View view) {
