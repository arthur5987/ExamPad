...
import com.xjhsk.exampad.model.http.exception.ApiException;
...
//                                return null;
//                            }
                            return Flowable.error(new ApiException(httpResponse.getMsg(), Integer.valueOf(httpResponse.getStatus())));
                        }
                    }
                });
            }
