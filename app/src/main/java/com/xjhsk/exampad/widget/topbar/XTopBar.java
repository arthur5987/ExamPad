package com.xjhsk.exampad.widget.topbar;
...
public class XTopBar extends AutoLinearLayout{

    private AutoLinearLayout time_layout;
    ...
    private void initView(){
        ...
        time_layout = (AutoLinearLayout) this.findViewById(R.id.time_layout);
...
//                }
    ...
    public void init() {
        //即将删除的方法
        if (EmptyUtils.isNotEmpty(v)&&v.isRunning()) {
            v.cancel();
        }
    }
